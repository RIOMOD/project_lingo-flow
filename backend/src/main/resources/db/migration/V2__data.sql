-- Seed data for a fresh MySQL 8 database.
...
INSERT INTO vocabularies (id, course_id, lesson_id, word, ipa, meaning, example_sentence, topic, level) VALUES
  (1, 1, 1, 'Greeting', '/griːtɪŋ/', 'Lời chào', 'She said a warm greeting.', 'Daily Conversation', 'BEGINNER'),
  (2, 1, 1, 'Polite', '/pəˈlaɪt/', 'Lịch sự', 'He is very polite.', 'Daily Conversation', 'BEGINNER'),
  (3, 1, 1, 'Apologize', '/əˈpɑːlədʒaɪz/', 'Xin lỗi', 'I apologize for being late.', 'Daily Conversation', 'BEGINNER'),
  (4, 1, 2, 'Resilient', '/rɪˈzɪliənt/', 'Phục hồi nhanh', 'She is a resilient girl.', 'Technology & Science', 'INTERMEDIATE'),
  (5, 1, 2, 'Meticulous', '/məˈtɪkjələs/', 'Tỉ mỉ', 'He is meticulous in his work.', 'Technology & Science', 'INTERMEDIATE');
...
-- Demo accounts, all using password: Password123!
-- admin@example.com
-- teacher@example.com
-- teacher2@example.com
-- student@example.com
