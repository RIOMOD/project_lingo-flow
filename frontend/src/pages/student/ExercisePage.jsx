...
export default function ExercisePage() {
  ...
  return (
    <div className="assessment-page focused-assessment">
      ...
      <div className="assessment-workspace" style={{ display: "grid", gridTemplateColumns: "1fr 280px", gap: "1.25rem" }}>
        <main>
          ...
          <div className="assessment-nav" style={{ display: "flex", justifyContent: "space-between", marginTop: "1.5rem" }}>
            ...
            {current < questions.length - 1 ? (
              <button
                type="button"
                onClick={() => setCurrent((v) => v + 1)}
                style={{ padding: "0.6rem 1.2rem", borderRadius: "10px", border: "none", background: "#0d9488", color: "#fff", fontWeight: 700, cursor: "pointer" }}
              >
                Câu tiếp theo
              </button>
            ) : (
              !submitted && (
                <button
                  type="button"
                  onClick={submit}
                  style={{ padding: "0.6rem 1.4rem", borderRadius: "10px", border: "none", background: "#0d9488", color: "#fff", fontWeight: 700, cursor: "pointer" }}
                >
                  Nộp bài ngay
                </button>
              )
        ...
        <aside className="assessment-question-map" style={{ background: "#fff", padding: "1.25rem", borderRadius: "16px", border: "1px solid #e2e8f0" }}>
