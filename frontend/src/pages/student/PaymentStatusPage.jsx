...
export default function PaymentStatusPage() {
  ...
  return (
    <div className="settings-container" style={{ maxWidth: "800px", margin: "0 auto", padding: "1.5rem" }}>
      ...
      <div className="commerce-card" style={{ borderRadius: "18px", padding: "1.2rem 1.8rem", marginBottom: "2rem", boxShadow: "0 4px 16px rgba(0,0,0,0.02)" }}>
      ...
      {/* Success Card */}
      <div className="commerce-card" style={{ borderRadius: "24px", padding: "3rem 2rem", textAlign: "center", boxShadow: "0 20px 40px rgba(0,0,0,0.05)" }}>
        ...
        <h2 className="commerce-card-title" style={{ fontSize: "1.6rem", margin: "0 0 0.6rem 0" }}>
          Thanh toán thành công! 🎉
        </h2>

        <p className="commerce-label" style={{ fontSize: "1rem", maxWidth: "520px", margin: "0 auto 1.5rem auto", lineHeight: 1.6 }}>
        ...
        <div className="commerce-summary-box" style={{ display: "inline-flex", gap: "12px", padding: "10px 18px", borderRadius: "12px", marginBottom: "2rem", fontSize: "0.88rem" }}>
        ...
        <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
          ...
          {orderCode && (
            <Link
              ...
              style={{ padding: "12px 20px", borderRadius: "12px", fontWeight: 600, fontSize: "0.92rem", textDecoration: "none", display: "inline-block" }}
            >
