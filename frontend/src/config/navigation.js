...
export const pageConfigs = {
  ...
  studentGrammar: {
    roleKey: "student",
    title: "Hoc ngu phap",
    description: "Trang tong hop cac diem ngu phap theo bài học va theo level, co vi du va bài tap lien quan.",
    stats: [stat("Rule", "Cau truc"), stat("Example", "Vi du"), stat("Practice", "Lien ket bài tap")],
    actions: [
      action("Ve bài học", demoPaths.studentLearning),
      action("Sang vocabulary", demoPaths.studentVocabulary, "secondary"),
      action("Mo bài tap", demoPaths.studentExercise, "ghost"),
    ],
    panels: [
      panel("Noi dung mong doi", ["Cong thuc", "Cach dung", "Loi thuong gap", "Vi du moi ngu canh"]),
      panel("Gia tri UX", ["Hoc nhanh theo card", "Lien ket sang bài tap ap dung ngay"]),
    ],
  },
  studentProgress: {
    roleKey: "student",
    title: "Tiến độ học tap",
    description: "Tong hop tiến do khóa học, bài da học, bài tap, test va xu huong học tap.",
    stats: [stat("78%", "Tiến độ demo"), stat("12", "Bai da hoan thanh"), stat("5", "Nhiem vu tiep theo")],
    actions: [
      action("Quay lai khóa học", demoPaths.studentMyCourses),
      action("Tiep tuc học", demoPaths.studentLearning, "secondary"),
      action("Mo AI writing", demoPaths.studentWriting, "ghost"),
    ],
    panels: [
      panel("Dashboard nen co", ["Theo khóa học", "Theo ky nang", "Theo tuan học", "Theo diem bài test"]),
      panel("Muc dich", ["Giup Student thay tiến bo", "Giup Teacher quan sat muc do tham gia"]),
    ],
  },
  studentChatbot: {
    roleKey: "student",
    title: "Chatbot AI",
    description: "Luyen hoi thoai, hoi dap ngu phap va thuc hanh tinh huong theo bài học.",
    stats: [stat("AI", "Hoi thoai"), stat("Context", "Theo bài học"), stat("History", "Luu phien")],
    actions: [
      action("Mo bài học", demoPaths.studentLearning),
      action("AI sua writing", demoPaths.studentWriting, "secondary"),
      action("Ve dashboard", demoPaths.studentDashboard, "ghost"),
    ],
    panels: [
      panel("Cần co", ["Khung chat", "Cau hoi goi y", "Chu de theo lesson", "Lich su tro chuyen"]),
      panel("Cần kiem soat", ["Quota su dung", "Timeout", "Noi dung an toan"]),
    ],
  },
  studentWritingCorrection: {
    roleKey: "student",
    title: "AI sua bài viet",
    description: "Nhap bài viet, gửi AI phan tich, sua loi va de xuat cau tot hon.",
  ...
  studentProfile: {
    roleKey: "student",
    title: "Ho so Student",
    description: "Quan ly thông tin ca nhan, muc tieu học tap va cac tuy chon tài khóan.",
